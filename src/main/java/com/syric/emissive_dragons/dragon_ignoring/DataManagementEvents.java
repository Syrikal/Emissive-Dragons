...
//            EmissiveDragons.LOGGER.debug("Attempting to synchronize client");
    ...
    private static void updateDataFromTags(EntityDragonBase dragon) {
        if (((Entity) dragon).level().isClientSide()) return;
//        EmissiveDragons.LOGGER.debug("Emissive Dragons checking dragon data");
